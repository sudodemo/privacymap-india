...
function ResidualRiskGovernance({
  decisions,
  onUpdate,
}: {
  decisions: ResidualRiskDecisionRecord[];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Manage residual-risk ownership,
          approval, escalation and periodic
          review requirements.
        </p>
        ...
        {decisions.map((decision) => (
          ...
          >
            ...
            >
              ...
              {decision.approvalStatus ===
              "Approved"
                ? "This residual-risk decision has been approved."
                : decision.approvalStatus ===
                  "Rejected"
                ? "This residual-risk decision has been rejected and requires reassessment."
                : "This residual-risk decision is awaiting appropriate approval."}
            </div>
          </div>
        ))}
      </div>
